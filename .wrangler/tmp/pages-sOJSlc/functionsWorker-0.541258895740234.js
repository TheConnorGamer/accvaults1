...
async function onRequestPost3(context) {
  ...
  try {
    ...
    console.log("\u2705 Ticket reopened:", ticketId);
    return new Response(JSON.stringify({
      success: true,
...
async function onRequestPost5(context) {
  ...
  try {
    ...
    const paylixResponse = await fetch(`https://dev.paylix.gg/v1/queries/close/${ticketId}`, {
      method: "POST",
      headers: {
    ...
    if (!paylixResponse.ok) {
      ...
      return new Response(JSON.stringify({ error: "Failed to close ticket" }), {
...
// ../.wrangler/tmp/pages-sOJSlc/functionsRoutes-0.9840175996702158.mjs
var routes = [
  {
