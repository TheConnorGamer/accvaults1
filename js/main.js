        ...
        <div class="product-selector-content">
            ...
            <div class="selector-products-grid">
                ${group.products.map((product, idx) => {
                    ...
                    return `
                        <div class="modal-product-card" style="display: flex !important; flex-direction: row !important; align-items: center; padding: 20px; gap: 20px; min-height: 130px !important; overflow: visible !important;">
                            ...
                            <div style="flex: 1; display: flex !important; flex-direction: column; gap: 6px; min-width: 0; overflow: visible !important;">
                                ...
                                <h4 class="modal-product-title" style="font-size: 14px !important; font-weight: 600 !important; color: #ffffff !important; margin: 0 !important; line-height: 1.3 !important; display: block !important; visibility: visible !important; opacity: 1 !important; max-height: 40px; overflow: visible !important;">${product.name}</h4>
                                <span class="modal-product-stock" style="font-size: 13px !important; color: #10b981 !important; font-weight: 800 !important; text-transform: uppercase; display: block !important; visibility: visible !important; opacity: 1 !important; white-space: nowrap; line-height: 1 !important; margin-top: 2px !important;">✓ IN STOCK</span>
                            </div>
                            <button 
                                class="modal-buy-btn" 
