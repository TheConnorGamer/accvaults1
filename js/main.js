                        ...
                        return `
                            <div class="modal-product-card" style="display: flex !important; flex-direction: column !important; padding: 12px;">
                                ...
                                <div class="modal-product-body" style="display: block !important; padding: 16px; visibility: visible !important; background: rgba(0,0,0,0.3);">
                                    <div style="display: flex !important; justify-content: space-between; align-items: flex-start; margin-bottom: 12px; gap: 20px;">
                                        ...
                                        <span class="modal-product-stock" style="font-size: 11px !important; color: #10b981 !important; font-weight: 700 !important; text-transform: uppercase; display: inline-block !important; white-space: nowrap; margin-left: auto;">✓ In Stock</span>
                                    </div>
