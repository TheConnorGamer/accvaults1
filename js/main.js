                            ...
                            <div class="modal-product-card" style="display: flex !important; flex-direction: column !important; padding: 12px;">
                                ...
                                <div class="modal-product-body" style="display: block !important; padding: 16px; visibility: visible !important; background: rgba(0,0,0,0.3);">
                                    <div style="display: flex !important; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                                        <span class="modal-product-price" style="font-size: 18px !important; font-weight: 700 !important; color: #a78bfa !important; display: inline-block !important; text-shadow: 0 2px 4px rgba(0,0,0,0.5); flex-shrink: 0;">£${product.price.toFixed(2)}</span>
                                        <span class="modal-product-stock" style="font-size: 11px !important; color: #10b981 !important; font-weight: 700 !important; text-transform: uppercase; display: inline-block !important; white-space: nowrap; padding-left: 20px;">✓ IN STOCK</span>
                                    </div>
