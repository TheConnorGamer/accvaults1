...
let productGroups = [
    ...
    },
    {
        id: 26,
        name: 'Social Boosts',
        description: 'Social Media Followers & Subscribers',
        category: '690ab6ad54eda',
        icon: '📱',
        badge: 'Popular',
            ...
            <div class="selector-products-grid">
                ${group.products.map((product, idx) => {
                    const logoContent = product.imageUrl 
                        ? `<img src="${product.imageUrl}" alt="${product.name}" style="width: 60px !important; height: 60px !important; object-fit: contain !important; border-radius: 8px !important; display: block !important;" onerror="console.error('Failed to load image:', this.src); this.style.border='2px solid red';">`
